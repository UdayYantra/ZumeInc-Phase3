 ...
 define(["N/search", "N/email"], function(search, email) {
    ...
    function _getEmailObject() {
        ...
        var prSearch = search.load({
            id : "customsearch_yil_pend_pr_daly_ntfctn"
        });

        log.debug({title:'PR Length', details: prSearch.runPaged().count});
    ...
    function _sendEmailsFromEmailObject() {
        if(emailObject.employeeId.length > 0) {
            for(var e=0;e<emailObject.employeeId.length;e++) {
                ...
                var emailSubject = "Pending PR Approval Notification: PR(s) pending for your approval as on "+currDtTxt+".";
                var emailBody = "";
                ...
                emailBody += "<html>";
                    emailBody += "<body>";
                        ...
                        emailBody += "<br/><br/>";
                        emailBody += "This is to bring to your notice that there "+emailRowsArr.length+" PR(s) pending for your Approval.";
                        emailBody += "<br/><br/>";
                            emailBody += "<table border= '1' cellspacing='0' cellpadding='5'>";
                            emailBody += "<tr><th><center><b>Sr. No.</b></center></th><th><center><b>PR Number</b></center></th><th><center><b>Vendor</b></center></th><th><center><b>Preparer</b></center></th><th><center><b>Requester</b></center></th><th><center><b>Created Date</b></center></th><th><center><b>Amount</b></center></th></tr>";
